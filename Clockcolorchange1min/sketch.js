...
function draw() {
  ...
  if (minute == 1) { // proud of this one! Hopefully figured it out -- should change the mycelium color  every hour. I tested by trying it at "second=1" instead of minute=59 then changed it back
    myceColor = (0,100,25);
//    let minute = 0;
